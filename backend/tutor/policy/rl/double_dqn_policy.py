...
class DoubleDQNPolicy:
    def __init__(
        ...
        self.gamma = gamma
        self.policy_net = QNetwork(state_dim, self.action_dim, hidden_dim)
        self.target_net = QNetwork(state_dim, self.action_dim, hidden_dim)
    ...
    @classmethod
    def load(cls, path: str | Path) -> "DoubleDQNPolicy":
