"""
Validate retention_predictor_report.json and refresh Markdown.

Run: python -m scripts.evaluation.check_retention_predictor_report
"""
...
from scripts.training.forgetting.train_retention_predictor import (  # noqa: E402
    build_markdown,
    save_json,
    train_and_report,
)
...
def main() -> None:
    ...
    print("MODULE: retention_predictor_report")
